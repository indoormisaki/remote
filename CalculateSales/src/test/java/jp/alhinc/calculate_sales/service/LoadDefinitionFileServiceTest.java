...
public class LoadDefinitionFileServiceTest {
    ...
    public void testIsCorrectLine正しいフォーマットのときtrueを返す() {
        assertEquals(true, TestHelper.run(TEST_CLASS,
                METHOD_NAME_IS_CORRECT_LINE, "001,東京支店"));
    }
    ...
    public void testIsCorrectLine文字列全体が空のときfalseを返す() {
        assertEquals(false, TestHelper.run(TEST_CLASS,
                METHOD_NAME_IS_CORRECT_LINE, new Object[] {null}));
    }
